...
function _crearJsonArticulos_02() {
    SolicitarDll({ datosh: datosEnvio() }, on_crearJsonArticulos_02, get_url("app/INV803.DLL"));
}
...
function _infoTanque(){
    ...
    var url = get_url("app/BOMB02.DLL");
...
function _dllBomb02_1(){
    ...
    SolicitarDll({ datosh: data }, on_dllBomb02_1, get_url("app/BOMB02_1.DLL"));
}
...
function _llenarDatos_02() {
    ...
    if (producto != false) {
        ...
        plantillaError('99', 'Producto no encontrado', '', function(){modificar_02('1');});
    }
}
