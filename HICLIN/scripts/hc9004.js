...
function iniciar_apertura() {
  var f = new Date();
  var fecha_hc={
    'dia_hc': cerosIzq(f.getDate(),2),
    'mes_hc': cerosIzq(f.getMonth(),2),
    'año_hc': f.getFullYear()
  }
  var data = datosEnvio() + llave + "|"+fecha_hc+'|';
	SolicitarDll(
		{ datosh: data },
		function(data) {
			var res = data.split("|");
		...
		get_url("APP/HICLIN/HC9004-0.DLL")
  );
}

function buscar_comprobantes(){
...
// 	var cods_nopos = [];
// 	$.getJSON(
// 		"http://" + $ip_servidor + "/hiclin/progdatos/json/CODCUM.JSON",
// 		function(json) {
// 			cods_cum = json["Medicamentos"]
// 				.map(function(arr) {
// 					let res = {
// 						id: arr["COD"],
...
// 			cods_pos = cods_cum.filter(
// 				arr => arr["type"] == "PO" || arr["type"] == "NONE"
// 			);
// 			cods_nopos = cods_cum.filter(
// 				arr => arr["type"] == "NP" || arr["type"] == "NONE"
// 			);
// 		}
// 	).done(function() {
...
// 	$("#embarazo_hc").val(2);
// 	$("#ginec_hc").val(
// 		"El paciente tuvo un embarazo prematuro hace aproximadamente 1 año"
// 	);
// 	$("#vlr_edad_dx_9004").val(37);
// 	$("#unid_edad_dx_9004").val("A");
// 	$("#motivo_prueba_dx_9004").val(2);
// 	$("#fecha_dx_9004").val(01012000);
// 	$("#plan_famil_9004").val(1), $("#tipo_def_dx_9004").val(2);
...
// 		.val("NP0002    461")
// 		.trigger("change");
// 	$("#cum_otros1_trat_9004")
// 		.val("POA01AA010101")
// 		.trigger("change");
// 	$("#cum_otros2_trat_9004")
// 		.val("NP00020001601")
// 		.trigger("change");
...
// 	$("#exa_general_hc").val(
// 		"Sin problemas o complicaciones paciente deshidratado por perdida de electrolitos"
// 	);
