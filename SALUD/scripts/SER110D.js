...
function _f8ciudad_SER110D(data) {
...
function _consultadoc_SER110D() {
    ...
    if (SER110D.DOCUMENTO.trim() == '') {
        ...
        console.log(datosEnvio() + SER110D.DOCUMENTO + '|')
        postData({
            ...
            .then((data) => {
                ...
                console.log(data, 'consulta cedula')
                ...
                if ((SER110D.NOVEDADW == '7') && (swinvalid == '01')) {
                    _validarciudaddoc_SER110D();
                }
                else if ((SER110D.NOVEDADW == '7') && (swinvalid == '00')) {
