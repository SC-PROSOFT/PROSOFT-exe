...
$(document).ready(function () {
    ...
    _toggleF8([
        // { input: 'lugar', app: '103', funct: _ventanaciudadnac},
        { input: 'Identificacion', app: '7767', funct: _ventanapacientes}
    ]);
...
function _dato_novedad_7767() {
    loader('hide');
    var novedades = '[{"codigo": "7","descripcion": "NUEVO"},{"codigo": "8", "descripcion": "CAMBIO"},{"codigo": "9","descripcion": "RETIRO"}]'
...
function _mostrarnovedad_7767(novedad) {
    $_SWCAMBIOW = "0"; 
...
function _validartipopac_7767() {
    var tipodoc = '[{"codigo": "CC","descripcion": "CEDULA CIUDADANIA"},{"codigo": "CE", "descripcion": "CEDULA EXTRANJERIA"},{"codigo": "PA","descripcion": "NUMERO PASAPORTE"},{"codigo": "RC","descripcion": "REGISTRO CIVIL"},{"codigo": "TI","descripcion": "TARJETA IDENTIDAD"},{"codigo": "ASI","descripcion": "ADULTO SIN IDENT"},{"codigo": "MSI","descripcion": "MENOR SIN IDENT"},{"codigo": "NUI","descripcion": "NUM UNICO IDENT. NUID"},{"codigo": "CD","descripcion": "CARNET DIPLOMA"},{"codigo": "SC","descripcion": "SALVO CONDUCTO"},{"codigo": "PE","descripcion": "PERMISO ESPECIAL PERM"},{"codigo": "CN","descripcion": "CERTIFICADO NACIDO VIVO"}]'
    var tipodocs = JSON.parse(tipodoc);
    POPUP({
        array: tipodocs,
...
function _evaluartipodoc_7767(data) {
    $_TIPOPACIW = data.id;
    switch (data.id) {
        case 'CC':
        case 'CE':
    ...
    $("#identif_110c").val(data.id + " - " + data.descripcion);
}
...
function _lugaridentificacion_7767() {
    ...
    // '<label class="col-md-4 col-sm-4 col-xs-4">CODIGO:</label>' +
    // '<div class="input-group col-md-8 col-sm-8 col-xs-8" id="LUGAR_110C">' +
    // '<input id="lugar_110c" class="form-control col-md-12 col-sm-12 col-xs-12" maxlength="5" data-orden="1">' +
    // '</div>' +
    // '</div>' +
    ...
    // '<div class="input-group col-md-8 col-sm-8 col-xs-8" id="LUGAR_110C">' +
    // '<input id="ciudadnaci_110C" class="form-control col-md-12 col-sm-12 col-xs-12" maxlength="15" data-orden="2">' +
    // '</div>' +
    // '</div>';
...
function _validarcivilpac_7767() {
    var civil = '[{"codigo": "S","descripcion": "SOLTERO"},{"codigo": "C", "descripcion": "CASADO"},{"codigo": "U","descripcion": "UNION LIBRE"},{"codigo": "V","descripcion": "VIUDO"},{"codigo": "D","descripcion": "SEPARADA"}]'
    var estadocivil = JSON.parse(civil);
    POPUP({
        array: estadocivil,
        titulo: 'ESTADO CIVIL'
    },
...
function _evaluarestadocivil_7767(data) {
    ...
    $("#civil_110c").val(data.id + " - " + data.descripcion);
}

function validacionestudio_7767(){

    var civil = '[{"codigo": "1","descripcion": "NINGUNO"},{"codigo": "2", "descripcion": "PRE-ESCOL"},{"codigo": "3","descripcion": "PRIMARIA"},{"codigo": "4","descripcion": "SECUNDARIA"},{"codigo": "5","descripcion": "BACH. BASIC"},{"codigo": "6","descripcion": "BACH. TECN"},{"codigo": "7","descripcion": "NORMALIST"},{"codigo": "8","descripcion": "TECN. PROFE"},{"codigo": "9","descripcion": "TECNOLOGI"},{"codigo": "A","descripcion": "PROFESION"},{"codigo": "B","descripcion": "ESPECIALI"},{"codigo": "C","descripcion": "MAESTRIA"},{"codigo": "D","descripcion": "DOCTORADO"}]'
    var estadocivil = JSON.parse(civil);
    POPUP({
        array: estadocivil,
        titulo: 'ESTADO CIVIL'
    },
        _evaluarestudio_7767);
}

function _evaluarestudio_7767(data) {

    $_NIVESTUPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
        case '3':
    ...
    $("#estudio_110c").val(data.id + " - " + data.descripcion);
}
...
function _evaluarestrato_7767(){
    ...
    var estrato = '[{"codigo": "0","descripcion": "NIVEL 0"},{"codigo": "1","descripcion": "NIVEL 1"},{"codigo": "2", "descripcion": "NIVEL 2"},{"codigo": "3","descripcion": "NIVEL 3"},{"codigo": "4","descripcion": "NIVEL 4"},{"codigo": "5","descripcion": "NIVEL 5"},{"codigo": "6","descripcion": "NIVEL 6"}]'
    var estratos = JSON.parse(estrato);
    POPUP({
        array: estratos,
...
function _datoestrato_7767(data) {
   
    $_ESTRATOPACIW = data.id;
    switch (data.id) {
        case '0':
        case '1':
        case '2':
    ...
    $("#nivel_110c").val(data.id + " - " + data.descripcion);
}
...
function _evaluarregimen_7767(){   
    var regimen = '[{"codigo": "C","descripcion": "CONTRIBUTIVO"},{"codigo": "S","descripcion": "SUBSIDIADO"},{"codigo": "V", "descripcion": "VINCULADO"},{"codigo": "P","descripcion": "PARTICULAR"},{"codigo": "O","descripcion": "OTRO TIPO"},{"codigo": "D","descripcion": "DESPLAZ CONT"},{"codigo": "E","descripcion": "DESPLAZ SUBS"},{"codigo": "G","descripcion": "DESPLAZ VINC"}]'
    var tipousuario = JSON.parse(regimen);
    POPUP({
        array: tipousuario,
        titulo: 'TIPO USUARIO'
    },
...
function _datoregimen2_7767(data) {

    $_REGIMENPACIW = data.id;
    switch (data.id) {
        case 'C':
        case 'S':
        case 'V':
    ...
    $("#regimen_110c").val(data.id + " - " + data.descripcion);
}
...
function _evaluaretnia_7767(){   
    ...
    var etnia = '[{"codigo": "1","descripcion": "INDIGE"},{"codigo": "2","descripcion": "RAIZAL"},{"codigo": "3", "descripcion": "GITANO"},{"codigo": "4","descripcion": "AFROCO"},{"codigo": "5","descripcion": "ROM"},{"codigo": "6","descripcion": "MESTIZO"},{"codigo": "9","descripcion": "NO APLICA"}]'
    var etnias = JSON.parse(etnia);
    POPUP({
        array: etnias,
        titulo: 'GRUPO ETNICO'
    },
...
function _seleccionaretnia_7767(data) {
    $_ETNIAPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
    ...
    $("#etnia_110c").val(data.id + " - " + data.descripcion);
}
...
function _evaluartipoafiliado_7767(){
    ...
    var afiliado = '[{"codigo": "1","descripcion": "COTIZANTE"},{"codigo": "2","descripcion": "BENEFICIARIO"},{"codigo": "3", "descripcion": "COT. PENSIONADO"},{"codigo": "4","descripcion": "UPC ADICIONAL"},{"codigo": "5","descripcion": "CABEZA FAMILIA"},{"codigo": "6","descripcion": "GRUPO FAMILIAR"},{"codigo": "0","descripcion": "SIN DETERMINAR"}]'
    var afiliados = JSON.parse(afiliado);
    POPUP({
        array: afiliados,
...
function _seleccionartipoafiliado_7767(data) {
    $_TIPOAFILPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
        case '3':
    ...
    $("#tipoafil_110c").val(data.id + " - " + data.descripcion);
}
...
function _evaluarparentezcopaci_7767(){
    ...
    var parentezco = '[{"codigo": "1","descripcion": "CONYUGUE"},{"codigo": "2","descripcion": "HIJO"},{"codigo": "3", "descripcion": "PADRES"},{"codigo": "4","descripcion": "2 GRADO"},{"codigo": "5","descripcion": "3 GRADO"},{"codigo": "6","descripcion": "< 12"},{"codigo": "7","descripcion": "SUEGRO"},{"codigo": "8","descripcion": "OTR-BE"},{"codigo": "0","descripcion": "COTIZANTE"}]'
    var familiar = JSON.parse(parentezco);
    POPUP({
        array: familiar,
...
function _seleccionrelacioncotiz_7767(data){
    $_PARENTPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
        case '3':
    ...
    $("#parentezco_110c").val(data.id + " - " + data.descripcion);
}
...
function peridocerticado_7767(){
    ...
    var periodo = '[{"codigo": "1","descripcion": "SEMESTRAL"},{"codigo": "2","descripcion": "ANUAL"}]'
    var pcertificados = JSON.parse(periodo);
    POPUP({
        array: pcertificados,
...
function _seleccionarperiodo_7767(data){
    $_PERIESTUDPACIW = data.id; 
    switch (data.id) {
        case '1':
        case '2':
...
function _peridocerticadoeco_7767(){
    var periodo = '[{"codigo": "1","descripcion": "SEMESTRAL"},{"codigo": "2","descripcion": "ANUAL"}]'
    var pcertificados = JSON.parse(periodo);
    POPUP({
        array: pcertificados,
...
function _seleccionarperiodoeco_7767(data){
    $_PERIECOPACIW = data.id; 
    switch (data.id) {
        case '1':
        case '2':
...
function _datoestado_7767(){
    ...
    if($_NOVEDAD7767 == '8'){
        var derecho = '[{"codigo": "1","descripcion": "En base de datos, ACTIVO"},{"codigo": "2","descripcion": "En base de datos, INACTIVO"},{"codigo": "3", "descripcion": "Creado por el  usuario"},{"codigo": "4","descripcion": "Pendiente por determinar"},{"codigo": "5","descripcion": "En base de datos, SIN CARNET"},{"codigo": "6","descripcion": "SUSPENDIDO, requiere autoriz"},{"codigo": "7","descripcion": "Afiliado Fallecido"},{"codigo": "8","descripcion": "Retiro X Multiafiliado"},{"codigo": "9","descripcion": "Ingreso X Traslado"},{"codigo": "A","descripcion": "Retiro  X Traslado"},{"codigo": "B","descripcion": "Periodo integral"}]'
        var derechos = JSON.parse(derecho);
        POPUP({
            array: derechos,
...
function _seleccionderecho_7767(data){
    $_DERECHOPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
        case '3':
    ...
    $("#basedatos_110c").val(data.id + " - " + data.descripcion);
}
...
function _seleccionardiscapacidad_7767(data){
    $_DISCAPPACIW = data.id;
    switch (data.id) {
        case '1':
        case '2':
        case '3':
    ...
    $("#discapacidad_110c").val(data.id + " - " + data.descripcion);
}
...
function _mostrardatos_7767(){
    ...
    // if(($_NOVEDAD7767 == '8') || ($_NOVEDAD7767 == '7')){
    //     _validartipopac_7767(); 
    // }else
    if ($_NOVEDAD7767 == '9'){
...
function _grabardatos_7767(){
    ...
    // $_DECRIPPACIW = $_APELLIDO1PACW + $_APELLIDO2PACW + $_NOMBRE1PACW + $_NOMBRE2PACW; 
    ...
    // $_DATOACTPACIW = $_OPERCREAPACIW  + $_FECHACREAPACIW + $_HORACREAPACIW + $_OPERMODIFPACIW + $_FECHAMODIFPACIW + $_HORAMODIFPACIW;
    ...
    LLAMADO_DLL({
        ...
        // callback: function (data) {
        //     validarbasesdatos_7767(data, $_CODPACIW)
        // },
...
// function validarbasesdatos_7767(data) {
//     console.debug(data)
//     loader('hide');
//     var rdll = data.split('|');
//     console.log(rdll[0])
//     if (rdll[0].trim() == '00') {
//         switch (parseInt($_NOVEDAD7767)) {
//             case 7:
